...
public class Principal extends JFrame {
	...
	public Principal() {
		...
		String[] nombreColumnas = { "Comunidad Aut", "Provincia", "Nº Habitantes", "Metros cuadrados" };
		...
		// Boton para añadir una nueva provincia con su comunidad autonoma, metros,
		// habitantes.
		...
		// Añado un listener a VentanaPreguntas para hacer algo cuando se cierre esta
		// ventana
		...
		vp.addWindowListener(new WindowAdapter() {
			...
			public void windowClosed(WindowEvent e) {
				...
				// Devolvuevo los datos para añadirlos a la tabla.
				intercambioDatos = vp.devolverDatos();
				System.out.println("Nombre=" + intercambioDatos.nombre);
				// El metodo siguiente lo que hace es añadir los datos a la tabla.
				anadirCiudad();
			}
		});
	...
	// En este metodo añado todos los datos que recojo en el dialogo y los añado a
	// la tabla.
